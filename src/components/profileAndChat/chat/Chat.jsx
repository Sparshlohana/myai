    ...
    return (
        <div className="relative w-[69vw]">
            ...
            <div className="absolute bottom-0 bg-[#620A08] w-full p-4 flex gap-5 items-center">
                ...
                <div className="w-full"><input name="chat" onChange={handleChange} value={messages} className="w-full py-2 px-3 bg-[#6d0d0a] text-white outline-none rounded" type="text" placeholder="Type a message..." /></div>
                {messages ? <div><RigthArrow className="fill-white  cursor-pointer" /></div> : <div><MicIcon className="fill-white  cursor-pointer" /></div>}
